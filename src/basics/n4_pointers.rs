pub mod pointers {
    ...
    */
    ...
    fn references() {
        /*
            - These pointer type is in-built in rust and is the most commonly used pointer type
            - Most core rust features are implemented using references and raw pointers
